...
public class PruebasDesempenioTest {
	
	private WebDriver driver;
	
	@Before
	public void setUpPruebasDesempenio() {
	...
	@Test
	public void testPruebasDesempenio() {
		...
		WebElement btnPruebasDesempenio = driver.findElement(By.xpath("//div[contains(@class,'elementor-element elementor-element-dc8f5c2 elementor-position-top elementor-vertical-align-top elementor-widget elementor-widget-image-box')]//div[contains(@class,'elementor-image-box-wrapper')]"));
		btnPruebasDesempenio.click();
		
		if(driver.findElement(By.id("performance")) != null) {
			assertTrue("Prueba exitosa", true);
		}else {
			fail("Prueba fallida");
		}
