...
public class SwitchesTest {
	...
	public void testSwitches() {
		...
		WebElement btnSwitches = driver.findElement(By.xpath("//div[@class='elementor-element elementor-element-b1f2969 elementor-position-top elementor-vertical-align-top elementor-widget elementor-widget-image-box']//div[@class='elementor-image-box-wrapper']"));
		btnSwitches.click();
		
		if(driver.findElement(By.id("transaccion")) != null) {
			assertTrue("Prueba exitosa", true);
		}else {
			fail("Prueba fallida");
		}
