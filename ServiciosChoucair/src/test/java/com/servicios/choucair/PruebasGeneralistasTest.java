...
public class PruebasGeneralistasTest {
	
	private WebDriver driver;
	
	@Before
	public void setUpPruebasGeneralistas() {
	...
	@Test
	public void testPruebasGeneralistas() {
		...
		WebElement btnPruebasGeneralistas = driver.findElement(By.xpath("//div[contains(@class,'elementor-element elementor-element-119690e elementor-position-top elementor-vertical-align-top elementor-widget elementor-widget-image-box')]//div[contains(@class,'elementor-image-box-wrapper')]"));
		btnPruebasGeneralistas.click();
		
		if(driver.findElement(By.id("generalistas")) != null) {
			assertTrue("Prueba exitosa", true);
		}else {
			fail("Prueba fallida");
		}
	...
	@After
	public void tearDownPruebasGeneralistas() {
