...
public class NominaTest {
	...
	public void testNomina() {
		...
		WebElement btnNomina = driver.findElement(By.xpath("//div[@class='elementor-element elementor-element-3fa8016 elementor-position-top elementor-vertical-align-top elementor-widget elementor-widget-image-box']//img[@class='elementor-animation-grow attachment-full size-full']"));
		btnNomina.click();
		
		if(driver.findElement(By.id("Nomina")) != null) {
			assertTrue("Prueba exitosa", true);
		}else {
			fail("Prueba fallida");
		}
