...
public class AmbientesPruebasTest {

	private WebDriver driver;
	
	@Before
	public void setUpAmbientesPruebas() {
	...
	@Test
	public void testAmbientesPruebas() {
		...
		WebElement btnAmbientesPruebas = driver.findElement(By.xpath("//div[@class='elementor-element elementor-element-b525775 elementor-position-top elementor-vertical-align-top elementor-widget elementor-widget-image-box']//div[@class='elementor-image-box-wrapper']"));
		btnAmbientesPruebas.click();
		
		if(driver.findElement(By.id("ambientes")) != null) {
			assertTrue("Prueba exitosa", true);
		}else {
			fail("Prueba fallida");
		}
	...
	@After
	public void tearDownAmbientesPruebas() {
