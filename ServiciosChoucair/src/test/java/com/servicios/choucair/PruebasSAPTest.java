...
public class PruebasSAPTest {
	
	private WebDriver driver;
	
	@Before
	public void setUpPruebasSAP() {
	...
	public void testPruebasSAP() {
		...
		WebElement btnPruebasSAP = driver.findElement(By.xpath("//div[contains(@class,'elementor-element elementor-element-36aa967 elementor-position-top elementor-vertical-align-top elementor-widget elementor-widget-image-box')]//div[contains(@class,'elementor-image-box-wrapper')]"));
		btnPruebasSAP.click();
		
		if(driver.findElement(By.id("sap")) != null) {
			assertTrue("Prueba exitosa", true);
		}else {
			fail("Prueba fallida");
		}
	...
	@After
	public void tearDownPruebasSAP() {
